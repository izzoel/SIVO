                    ...
                    <form action="{{ route('takeCair', '') . '/' . $m->id }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row p-2 m-2 mt-0">
                                ...
                                <input class="form-control form-control-sm" id="ambil" name="ambil"
                                    type="text">
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row p-2 m-2 mt-0">
                            <label for="ambil">Jumlah Pengambilan</label>
                            <input class="form-control form-control-sm" id="ambil" type="text"
                                placeholder="">
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('login') }}" method="post">
                    <div class="modal-body">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInpusernameutEmail1" class="form-label">Username</label>
