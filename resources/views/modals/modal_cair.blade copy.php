@foreach ($dcair as $m)
    <div class="modal fade" id="cair{{ $m->id }}" tabindex="-1" aria-labelledby="modalBahanCair" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <form id="takeForm"
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <input type="hidden" name="lokasi" value="{{ $m->stok }}">
                    ...
                    <input type="text" name="nim" value="{{ $biodata->nim }}">
                    <input type="text" name="tanggal" value="{{ Carbon\Carbon::now() }}">
                    <input type="text" name="keperluan" value="{{ $keperluan }}">
                    <input type="text" name="ambil" id="value_ambil">
