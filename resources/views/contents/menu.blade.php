    ...
    <main id="main">
                ...
                <div class="modal fade modal-cair" id="take_cair{{ $cair->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            ...
                            <form class=""
                                action="{{ route('store_take', ['jenis' => $title, 'id' => $cair->id]) }}"
                                method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ps-0 pe-0">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-auto">:</div>
                                            <div class="col-8"><span
                                                    class="badge bg-primary">{{ $cair->lokasi }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control take-angka"
                                                    id="ambil{{ $cair->id }}" placeholder="..." required
                                                    name="ambil">
                ...
                <div class="modal fade modal-cair" id="put_cair{{ $cair->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">
                                    <a class="btn btn-warning"><i class="bx bxs-archive-in"></i><b>
                                            {{ $cair->nama }}
                                        </b></a>
                                </h5>
                            ...
                            <form class="submit-form"
                                action="{{ route('store_put', ['jenis' => $title, 'id' => $cair->id]) }}"
                                method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ps-0 pe-0">
                ...
                <div class="modal fade" id="setting_cair{{ $cair->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            ...
                            <form id="form-updateCair{{ $cair->id }}"
                                action="{{ route('update-cair', $cair->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ms-1 me-1 p-0">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control" placeholder="..."
                                                    name="namaEdit" value="{{ $cair->nama }}" required>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-1">:</div>
                                            <div class="col">
                                                <select class="form-select" id="lokasi" name="lokasiEdit"
                                                    required>
                                ...
                                <div class="modal-footer d-flex">
                                    <div class="me-auto p-2">
                                        <a class="btn btn-danger btn-sm"
                                            href="{{ route('destroy-cair', $cair->id) }}"
                ...
                <div class="modal fade modal-padat" id="take_padat{{ $padat->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            ...
                            <form class=""
                                action="{{ route('store_take', ['jenis' => $title, 'id' => $padat->id]) }}"
                                method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ps-0 pe-0">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-auto">:</div>
                                            <div class="col-8"><span
                                                    class="badge bg-primary">{{ $padat->lokasi }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control take-angka"
                                                    id="ambil{{ $padat->id }}" placeholder="..." required
                                                    name="ambil">
                ...
                <div class="modal fade modal-padat" id="put_padat{{ $padat->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">
                                    <a class="btn btn-success"> <i class="bx bxs-archive-in"></i><b>
                                            {{ $padat->nama }}
                                        </b></a>
                                </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            ...
                            <form class="submit-form"
                                action="{{ route('store_put', ['jenis' => $title, 'id' => $padat->id]) }}"
                                method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ps-0 pe-0">
                ...
                <div class="modal fade" id="setting_padat{{ $padat->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            ...
                            <form id="form-updatePadat{{ $padat->id }}"
                                action="{{ route('update-padat', $padat->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ms-1 me-1 p-0">
                                ...
                                <div class="modal-footer d-flex">
                                    <div class="me-auto p-2">
                                        <a class="btn btn-danger btn-sm"
                                            href="{{ route('destroy-padat', $padat->id) }}"
                                            onclick="return confirm('Hapus data ini?')" role="button">
                                            <i class="bx bx-trash"></i>
                                        </a>
                                    </div>
                ...
                <div class="modal fade modal-alat" id="take_alat{{ $alat->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            ...
                            <form class=""
                                action="{{ route('store_take', ['jenis' => $title, 'id' => $alat->id]) }}"
                                method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ps-0 pe-0">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-auto">:</div>
                                            <div class="col-8"><span
                                                    class="badge bg-primary">{{ $alat->lokasi }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <div class="modal fade modal-alat" id="put_alat{{ $alat->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            ...
                            <form class="submit-form"
                                action="{{ route('store_put', ['jenis' => $title, 'id' => $alat->id]) }}"
                                method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ps-0 pe-0">
                ...
                <div class="modal fade modal-alat" id="setting_alat{{ $alat->id }}" tabindex="-1">
                    <div class="modal-dialog" style="width: 30%">
                        <div class="modal-content">
                            ...
                            <form id="form-updateAlat{{ $alat->id }}"
                                action="{{ route('update-alat', $alat->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="modal-body">
                                    <div class="container mb-4 ms-1 me-1 p-0">
                                ...
                                <div class="modal-footer d-flex">
                                    <div class="me-auto p-2">
                                        <a class="btn btn-danger btn-sm btn-destroy"
                                            href="{{ route('destroy-alat', $alat->id) }}"
                                            id="destroyAlat{{ $alat->id }}"
                                            onclick="return confirm('Hapus data ini?')" role="button">
                                            <i class="bx bx-trash"></i>
                                        </a>
                                    </div>
        ...
        @elseif($title == 'satuan')
            ...
            @foreach ($satuans as $satuan)
                <div class="modal fade" id="edit_satuan{{ $satuan->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form id="form-updateSatuan{{ $satuan->id }}"
                                action="{{ route('update-satuan', $satuan->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="..."
                                                name="satuanEdit" value="{{ $satuan->satuan }}" required>
                                        </div>
                                    </div>
                                </div>
        ...
        @elseif($title == 'lokasi')
            ...
            @foreach ($lokasis as $lokasi)
                <div class="modal fade" id="edit_lokasi{{ $lokasi->id }}" tabindex="-1"
                    data-bs-keyboard="false">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form id="form-updateLokasi{{ $lokasi->id }}"
                                action="{{ route('update-lokasi', $lokasi->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="..."
                                                name="lokasiEdit" value="{{ $lokasi->lokasi }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary btn-sm"
                                        id="updateLokasi{{ $lokasi->id }}">Simpan</button>
                                </div>
                            </form>
        ...
        @elseif($title == 'laboratorium')
            ...
            @foreach ($laboratoriums as $laboratorium)
                <div class="modal fade" id="edit_laboratorium{{ $laboratorium->id }}" tabindex="-1"
                    data-bs-keyboard="false">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form id="form-updateLaboratorium{{ $laboratorium->id }}"
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="..."
                                                name="laboratoriumEdit" value="{{ $laboratorium->laboratorium }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
