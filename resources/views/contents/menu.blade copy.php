    ...
    <section id="about" class="about">
        <div class="container">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-cair" role="tabpanel" aria-labelledby="nav-cair-tab">
...
{{-- @foreach ($dpadat as $n)
    ...
    @auth
        <div class="modal fade" id="restok_padat{{ $n->id }}" tabindex="-1" aria-labelledby="modalBahanCair"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
